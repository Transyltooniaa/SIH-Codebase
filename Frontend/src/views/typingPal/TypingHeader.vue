<template>
    ...
    <div>
        <link rel="shortcut icon" type="image/png" href="img/brand/green.png">

        <div class="header-typing">
            <div>
            </div>
...
@media (min-width: 600px) {
    .control-center, .control-right {
        width: 20%; /* Keep 20% width on larger screens */
    }
}

svg {
    width: 30px;  /* Adjust this value to increase/decrease the width */
    height: 30px; /* Adjust this value to increase/decrease the height */
    color: white;
}
